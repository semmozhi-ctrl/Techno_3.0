...
const DEADLINE_LEVEL2 = new Date('2025-10-17T00:12:00').getTime(); // Oct 16, 9:00 PM (Round 2)
const RESULTS_LEVEL2_ANNOUNCEMENT = new Date('2025-10-17T00:12:00').getTime(); // Oct 16, 10:00 PM (1 hour after Level 2 deadline)
